        ...
        return(
            ...
            <View style={{flex:1, backgroundColor: 'white'}}>
                <View style={{backgroundColor: colors.initialDarkGreen, height: 220, justifyContent: 'space-around',flexDirection: 'row',paddingTop: 40}}>
                    ...
                    <TouchableOpacity onPress={() => navigate('SettingsPage')} style={{marginLeft: 40,marginTop: 5}}><Icons name={'cog'} size={25} color='white'/></TouchableOpacity>
                    <TouchableOpacity onPress={() => navigate('EditProfile')} style={{marginLeft: 20,marginTop: 5, marginRight: 20}}><Icons name={'edit'} size={25} color='white'/></TouchableOpacity>
                    </View>
                </View>
