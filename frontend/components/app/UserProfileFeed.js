    ...
    return (
      <ScrollView style={{ flex: 1, backgroundColor: 'white' }}>
        <View style={{ flex: 1, backgroundColor: 'white' }}>
          <View
            ...
            <View style={{ marginLeft: 40, marginTop: 50 }}>
              ...
              <TouchableOpacity
                ...
                <Icon name="award" size={32} color={colors.initialDarkGreen} />
              </TouchableOpacity>
              <Text
                style={{
            ...
            <View style={{ flexDirection: 'row' }}>
              <TouchableOpacity
                ...
                <Icons name="cog" size={25} color="white" />
              </TouchableOpacity>
              <TouchableOpacity
          ...
          <View
            style={{ flex: 1, marginLeft: 30, marginRight: 30, marginTop: 20 }}>
            <LinearGradient
              style={{
                borderRadius: 25,
              ...
              <TouchableOpacity onPress={() => navigate('ActivityCreate')}>
                <Text
                  style={{
                    fontSize: 14,
                    textAlign: 'center',
          ...
          <View style={{ marginLeft: 30, marginTop: 20, marginRight: 30 }}>
            ...
            <View style={{ marginTop: 10 }}>
              <Text>
                Availability:
                <Text style={{ color: colors.initialDarkGreen }}>
                  23/02/20 - 23/04/20
                </Text>
              </Text>
              <Text>
              ...
              <Text>
                Women only:
                <Text style={{ color: colors.initialDarkGreen }}>Yes</Text>
              </Text>
              <Text>
                Placeholder:
                <Text style={{ color: colors.initialDarkGreen }}>
          ...
          <View style={{ marginLeft: 30, marginTop: 20, marginRight: 30 }}>
            ...
            <View style={{ marginTop: 10 }}>
              <Text>
                ...
                eiusmod temporary incididunt ut labore et dolore magna aliqua.
              </Text>
              <Text />
              <Text>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do.
          ...
          <View style={{ backgroundColor: colors.backgroundGrey, height: 350 }}>
            <View
              ...
              <HorizontalEventsList
                categoryTitle="Upcoming Activities"
                expandList="Past Activities"
                DATA={Events}
              />
            </View>
          </View>
