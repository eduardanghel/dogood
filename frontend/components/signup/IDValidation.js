      ...
      <SafeAreaView style={styles.container}>
        <View style={styles.form}>
          ...
          <Text style={styles.paragraph}>
            We need you to verify who you are for your safety and the safety of
            others. It’s quick, easy and totally secure.
          </Text>
          <Text />
          <Text />
          <Text style={styles.paragraph}>
            You will be asked to verify using photo ID and your phone number.
          </Text>
        </View>
